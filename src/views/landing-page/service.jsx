...
export default function ServiceSection() {
  ...
  return (
    <>
      <div className="absolute mt-[-50px] left-1/2 transform -translate-x-1/2 w-[80%] max-w-7xl z-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 space-y-6">
      ...
      <section className="w-[90%] max-w-8xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 mt-[60px]">
        <Slider {...settings}>
          {filteredData.map((item) => (
            <div key={item.id} className="px-3 opacity-0 animate-fade-slide">
              <div className="overflow-hidden bg-white shadow rounded-xl">
                ...
                <div className="p-4 min-h-[350px] flex flex-col justify-between">
                  <h2 className="mb-0 font-semibold ">{item.name}</h2>
                  ...
                  <p className="mt-1 text-green-500">{item.harga}</p>
                  <div className="flex justify-between mt-4">
                    ...
                    <button className="px-3 py-1 text-sm border rounded border-biru">
                      Lihat Detail
                    </button>
                  </div>
